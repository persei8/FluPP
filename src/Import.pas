...
procedure readValStrings(XMLElem: TDOMNode; StringList: TStrings);
var i: Word;
begin
...
procedure readObjStrings(XMLElem: TDOMNode; var StringList: TStrings);
var i: Word;
begin
...
procedure readFlight(XMLElem: TDOMNode);
var i, Col: Word;
begin
...
procedure readColumns(XMLElem: TDOMNode);
var i, Col: Word;
begin
...
procedure OpenFlpFile7(XML : TXMLDocument);
...
procedure OpenFluFile1(XML : TXMLDocument);
var XMLRootIdx, XMLIdx: Word;
    FLElem: TDOMNode;
    FlightLogName : String;    
begin
...
var
  ...
  Column, i : Word;
  AircraftID, AircraftType: TStringList;
begin
...
{ Einstellungen lesen }
  ...
  begin
    CloseFile(AFile);
    MessageDlg(('This version of the file is not compatible anymore'),mtWarning,[mbOK],0);
    Exit;
  end;
  Readln(AFile,RowText);
  while i < length(RowText) do
