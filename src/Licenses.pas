...
type
  ...
  private
    ...
    function GetActualValue(CurFlb: Word; XMLElem:TDOMNode; Date: String; Category, TimeCat: String): String;
    function ValidTo(CurFlb: Word; XMLElem: TDOMNode; Category, TimeCat: String): String;
    ...
    function AddSubNode(Node: PVirtualNode; XMLElem:TDOMNode; Value, Date: String): PVirtualNode;
        ...
        begin
          ...
          begin;
            try
              ...
              on E: Exception do
              begin
                MemoDesc.Lines.Add(('Error')+': '+E.Message);
                Continue;
              end;
            end;
...
// Add sub node
// ----------------------------------------------------------------
function TFLicenses.AddSubNode(Node: PVirtualNode; XMLElem:TDOMNode; Value, Date: String): PVirtualNode;
var
  TreeData: TTreeData;
  ValueType: String;
  Req: String;
...
begin
  ...
  if NodeData.DataType = Currency then
   if NodeData.Date <> '' then
    SchedValidity.Values[('Currency') +': '+ ParentCaption] := NodeData.Date;
end;
...
// Get actual value
// ----------------------------------------------------------------
function TFLicenses.GetActualValue(CurFlb: Word; XMLElem:TDOMNode; Date: String; Category, TimeCat: String): String;
var
  ReDate: TDate;
...
// ----------------------------------------------------------------
function TFLicenses.ValidTo(CurFlb: Word; XMLElem: TDOMNode; Category, TimeCat: String): String;
var
  i, Flb, Row, Starts: Word;
  ValueType, Req, Month, Time: String;
  IsAccLicense: Boolean;
