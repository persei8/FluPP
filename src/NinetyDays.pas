...
begin
  ...
  GridNinetyDaysFlz.Cells[0,0] := ('Aircraft ID');
  GridNinetyDaysFlz.Cells[1,0] := ('Flights');
  GridNinetyDaysFlz.Cells[2,0] := ('3 flights to');
  GridNinetyDaysFlz.ColWidths[0] := 150;
  GridNinetyDaysFlz.ColWidths[1] := 50;
  GridNinetyDaysFlz.ColWidths[2] := 80;

  GridNinetyDaysLic.Cells[0,0] := ('Flight log');
  GridNinetyDaysLic.Cells[1,0] := ('Flights');
  GridNinetyDaysLic.Cells[2,0] := ('3 flights to');
