...
begin
  ...
  begin
    try StrToDate(CBDateFrom.Text)
      ...
      on EConvertError do
      begin
        MessageDlg(('Please enter date'),mtError,[mbOK],0);
  ...
  try FMain.CreateNewWindow('Print','< Schein >');
    ...
    begin
      ...
      begin
        ...
        begin
          Messagedlg(('Please fill out "Licence obtained"!'),mtWarning,[mbOK],0);
    ...
    if ((GridActiveChild.Grid.RowCount = 2) and (GridActiveChild.Data['Num',1] = '')) then begin
      MessageDlg(('No data found'),mtInformation,[mbOK],0); Exit;
    end;
    ...
    with Print do begin
      ...
      //begin
      //  messagedlg(('Too many columns for one page!'),mtError,[mbOK],0);
      //  abort; exit;
      //end;
      //
...
begin
  ...
  //  ColPos := 0;
  //  ColNum := 1;
  //  SetColumnHeader(6.2,1,('Nr.'));
  //  SetColumnHeader(6.2,1,('Date'));
  //  SetColumnHeader(3.1,2,('Aircraft'));
  //  SetColumnHeader(3.1,2,('Pilot')+' / '+('Passenger'));
  //  SetColumnHeader(6.2,1,('Type'));
  //  SetColumnHeader(3.1,2,('Time'));
  //  SetColumnHeader(6.2,1,('Duration'));
  //  SetColumnHeader(3.1,2,('BlockTime'));
  //  SetColumnHeader(6.2,1,('Duration'));
  //  SetColumnHeader(6.2,1,('Ld.'));
  //  SetColumnHeader(3.1,2,('Airport'));
  //  SetColumnHeader(6.2,1,('Distance'));
  //  SetColumnHeader(6.2,1,('Categories'));
  //  SetColumnHeader(6.2,1,('Via'));
  //  SetColumnHeader(6.2,1,('Times'));
  //  SetColumnHeader(6.2,1,('Contests'));
  //  SetColumnHeader(6.2,1,('Remarks'));
  //
  ...
  //
  //  SetColumnHeader2(3,('Type'));
  //  SetColumnHeader2(4,('ID'));
  //  SetColumnHeader2(5,('Pilot'));
  //  SetColumnHeader2(6,('Copilot'));
  //  SetColumnHeader2(8,('Dep.'));
  //  SetColumnHeader2(9,('Arr.'));
  //  SetColumnHeader2(11,('Block off'));
  //  SetColumnHeader2(12,('Block on'));
  //  SetColumnHeader2(15,('From'));
  //  SetColumnHeader2(16,('To'));
  //  SetFontSize(9);
  //
  //  NextLine;
  //  SetFontSize(6);
