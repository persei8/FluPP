...
begin
  ...
  begin
    ...
    if TotalPoints < 1/3 then
      LabelText.Caption := ('Red Area')+#13#10+
        ('Exercise is necessary - Flying can be risky.')+#13#10+#13#10+
        ('For Novices:'+#13#10+
    ...
    if (TotalPoints >= 1/3) and (TotalPoints < 2/3) then
      LabelText.Caption := ('Yellow Area')+#13#10+
        ('More exercise helpful - Unexpected events could be dangerous')+#13#10+#13#10+
        ('Attention on takeoff:'+#13#10+
    ...
    if TotalPoints >= 2/3 then
      LabelText.Caption := ('Green Area')+#13#10+
        ('The level of exercise is good - but stay cautious!')+#13#10+#13#10+
        ('Well trained pilots often make the following mistakes:'+#13#10+
